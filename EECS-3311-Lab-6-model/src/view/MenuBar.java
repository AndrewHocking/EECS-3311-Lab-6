...
public class MenuBar extends JMenuBar {
	...
	public MenuBar(ActionListener menubarListener) {
		...
		updateModelMenu.add(createMenuItem("Save input centimetres", "Save input centimetres", KeyEvent.VK_F, KeyEvent.ALT_DOWN_MASK, menubarListener));
	 ...
	 * @param modifier - The modifier key to be held down with the accelerator key (set to 0 for no modifier key).
	 * @param listener - The ActionListener to listen for interaction with the menu item.
	 * @return The new menu item.
	 */
	private JMenuItem createMenuItem(String text, String actionCommand, int accelerator, int modifier, ActionListener listener) {
